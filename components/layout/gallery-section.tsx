...
//         {/* HEADER */}
//         <div className="flex flex-col md:flex-row justify-between md:items-end gap-10 mb-14">
//           <div>
//             <p className="text-xs uppercase tracking-[0.35em] text-[#D8C48A]">
//               Moments
//             </p>

//             <h2 className="mt-5 text-5xl md:text-7xl font-medium tracking-[-0.05em] leading-[0.9]">
//               Life at
//               <br />
//               Mustard Seed.
//             </h2>
...
//             <Link
//               href="/gallery"
//               className="group mt-7 inline-flex items-center gap-3 border-b border-white/20 pb-2 text-xs uppercase tracking-[0.2em] hover:border-[#D8C48A] transition"
//             >
//               View full gallery
...
//         {/* GRID */}
//         <div className="grid grid-cols-2 md:grid-cols-4 auto-rows-[150px] md:auto-rows-[180px] gap-[2px] bg-white/10">
...
//                 delay: index * 0.06,
//               }}
//               className={`relative overflow-hidden bg-[#222] ${image.className}`}
//             >
//               <Image
//                 src={image.src}
...
//         {/* FOOTER */}
//         <div className="mt-6 flex justify-between items-center text-xs uppercase tracking-[0.2em] text-white/30">
//           <span>01 — 07</span>
